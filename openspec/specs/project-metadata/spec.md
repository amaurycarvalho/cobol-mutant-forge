...
Define the repository-level metadata, release, and CI conventions for the Cobol Mutant Forge freeware CLI tool, covering versioning, language, build tooling, automation, and template cleanup.
