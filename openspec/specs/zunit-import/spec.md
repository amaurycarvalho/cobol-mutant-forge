...
Import objects exported by IBM ZUnit from CICS — `.xml` test data, `.bzucfg` configuration, `.cbl` source, and COPYBOOKS — into the domain model through a plugin implementing `IImportPlugin`.
