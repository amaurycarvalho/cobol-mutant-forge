...
Generate mutations from parsed COBOL programs by walking the AST and applying operator and expression mutation strategies gated by the active mutation profile.
