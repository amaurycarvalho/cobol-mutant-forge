...
Provide the command-line interface surface exposing `init`, `generate`, `export`, `plugin list`, `--help`, and `--version`, wiring the application and infrastructure layers behind a System.CommandLine composition root.
