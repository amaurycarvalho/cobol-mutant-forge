...
Define the domain entities, value objects, aggregate root, and ports that model COBOL programs, mutations, and mutation projects for the Cobol Mutant Forge tooling.
