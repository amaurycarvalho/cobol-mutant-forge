...
Define the foundational project structure, build configuration, and shared contracts that all other capabilities of the Cobol Mutant Forge tooling rely on.
